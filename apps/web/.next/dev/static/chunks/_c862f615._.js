...
const mockReports = [
    {
        ...
        description: "Lampa de pe Str. Lalelelor 14 nu mai funcționează de 3 zile.",
        status: "NEW",
    ...
    {
        id: "rep-02",
        title: "Gropi în carosabil",
        description: "Segmentele din apropiere de Piața Avram Iancu sunt greu de traversat.",
        status: "IN_PROGRESS",
    ...
    {
        id: "rep-03",
        title: "Deșeuri abandonate",
        description: "Malul Someșului a fost din nou încărcat cu saci menajeri.",
        status: "RESOLVED",
...
async function patchReportStatus(reportId, status) {
    await new Promise((resolve)=>setTimeout(resolve, 600));
    console.info(`PATCH /api/reports/${reportId}/status -> ${status}`);
    return status;
}
function AdminDashboard() {
    ...
    const handleStatusChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDashboard.useCallback[handleStatusChange]": async (reportId, nextStatus)=>{
            ...
            setReports({
                "AdminDashboard.useCallback[handleStatusChange]": (prev)=>prev.map({
                        "AdminDashboard.useCallback[handleStatusChange]": (report)=>report.id === reportId ? {
                                ...report,
                                status: nextStatus
                            } : report
                    }["AdminDashboard.useCallback[handleStatusChange]"])
            ...
            try {
                await patchReportStatus(reportId, nextStatus);
            } catch (error) {
                console.error("Nu am putut actualiza statusul", error);
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: reports.map((report)=>{
                        ...
                        const isUpdating = Boolean(pending[report.id]);
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex flex-wrap gap-3 text-xs text-slate-500",
                                    children: [
                                        report.city ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "rounded-full bg-slate-100 px-3 py-1",
                                            children: report.city
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/AdminDashboard.tsx",
                                            lineNumber: 163,
                                            columnNumber: 34
                                        }, this) : null,
                                        report.author ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "rounded-full bg-slate-100 px-3 py-1",
                                            children: [
                                                "Autor: ",
                                                report.author
...
_s(AdminDashboard, "EjTBV0zm0qV3uh0dE3kA8dVMafU=");
_c = AdminDashboard;
var _c;
...
//# sourceMappingURL=_c862f615._.js.map